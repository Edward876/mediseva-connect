...
export const bnTranslations = {
  ...
  "doctors.specialty": "বিশেষজ্ঞতা",
  "doctors.location": "অবস্থান",
  "doctors.doctor": "ডাক্তার",
  "doctors.doctors": "ডাক্তার",
  "doctors.found": "পাওয়া গেছে",
  "doctors.filters": "ফিল্টার",
  "doctors.viewProfile": "প্রোফাইল দেখুন",
  "doctors.bookAppointment": "অ্যাপয়েন্টমেন্ট বুক করুন",
  "doctors.noResults": "কোন ডাক্তার পাওয়া যায়নি। অনুগ্রহ করে আপনার অনুসন্ধান পরিবর্তন করুন।",
  "doctors.clearFilters": "ফিল্টার মুছুন",
  
  // Login page
  "login.title": "সাইন ইন",
  "login.subtitle": "মেডিসেবাতে স্বাগতম",
  "login.email": "ইমেল",
